...
T = 100.                     # Set the initial temperature
...
time = 1000./dt_fs          # Set total time of the MD trajectory (Note: This trajectory is for 50,000 femtoseconds and will work for any timestep)
