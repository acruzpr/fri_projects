...
T = 3000.                     # Set the initial temperature
...
time = 5000./dt_fs          # Set total time of the MD trajectory (Note: This trajectory is for 50,000 femtoseconds and will work for any timestep)
