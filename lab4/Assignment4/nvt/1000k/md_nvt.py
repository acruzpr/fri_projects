...
time = 50000./dt_fs          # Set total time of the MD trajectory (Note: This trajectory is for 50,000 femtoseconds and will work for any timestep)
...
for i in range(int(time)):
    ...
    stepNumberArr.append(dt_fs*(i+1))
