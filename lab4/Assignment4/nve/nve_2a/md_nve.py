...
time = 1000./dt_fs            # Set total time of the MD trajectory (Note: This trajectory is for 20 femtoseconds and will work for any timestep)
...
title('Energy Deviation over time, NVE, ' + str(dt_fs) + 'K')
