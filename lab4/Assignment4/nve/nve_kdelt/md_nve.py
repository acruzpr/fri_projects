...
T = 1000.                    # Set the initial temperature
...
for i in range(int(time)):
    ...
    energyPercentArr.append(abs((p.get_total_energy()-initialEnergy)/initialEnergy))
...
title('Energy Deviation over time, NVE, ' + str(T) + 'K')
savefig('deviation.png')

figure()
plot(stepNumberArr, energyPercentArr)
xlabel('Time')
ylabel('Percent Deviation')
title('Energy Percent Deviation over time, NVE, ' + str(T) + 'K')
savefig('p_dev.png')
