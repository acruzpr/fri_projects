...
xlabel('Nth Step')
ylabel('Radius')
title('Radius used in iterative approximation, a=.002')
savefig('LJ6R.png')
...
xlabel('Nth Step')
ylabel('Force')
title('Forces in iterative approximation, a=.002')
savefig('LJ6F.png')
...
title('Potential Energy in iterative approximation, a=.002')
savefig('LJ6E.png')
