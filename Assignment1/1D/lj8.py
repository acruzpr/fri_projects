...
xlabel('Nth Step')
ylabel('Radius')
title('Radius used in iterative approximation, a=.000001')
savefig('LJ8R.png')
...
xlabel('Nth Step')
ylabel('Force')
title('Forces in iterative approximation, a=.000001')
savefig('LJ8F.png')
...
title('Potential Energy in iterative approximation, a=.000001')
savefig('LJ8E.png')
