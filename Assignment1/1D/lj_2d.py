...
print F(rAt, sigma, epsilon)
while F(rAt, sigma, epsilon) > goal:
    ...
    magArr = numpy.append(magArr, F(rAt, sigma, epsilon))
    peArr = numpy.append(peArr, LJ(rAt, sigma, epsilon))
...
xlabel('Nth Step')
ylabel('Radius')
title('Radius used in iterative approximation, a=.005')
savefig('LJ5R.png')
...
xlabel('Nth Step')
ylabel('Force')
title('Forces in iterative approximation, a=.005')
savefig('LJ5F.png')
...
title('Potential Energy in iterative approximation, a=.005')
savefig('LJ5E.png')
